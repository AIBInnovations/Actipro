          ...
          <div className="partners-card">
            <div className="partners-card__inner">
              ...
              <div className="partners-card__flex">
                <img src="/assets/img/pack-sunflower.webp" alt="Actipro Sunflower" loading="lazy" />
            ...
            <div className="partners-card__inner">
              <div className="partners-card__tag">Our Range</div>
              <div className="partners-card__flex">
                <img src="/assets/img/pack-corn.webp" alt="Actipro Corn" loading="lazy" />
            ...
            <div className="partners-card__inner">
              <div className="partners-card__tag">Our Range</div>
              <div className="partners-card__flex">
                <img src="/assets/img/pack-rice-bran.webp" alt="Actipro Rice Bran" loading="lazy" />
            ...
            <div className="partners-card__inner">
              <div className="partners-card__tag">Our Range</div>
              <div className="partners-card__flex">
                <img src="/assets/img/pack-range.webp" alt="Actipro Tasting Trio" loading="lazy" />
